...
//
//   id           uuid PK
//   actor_id     the actor, as a USER id (NULL for failed auth attempts)
...
//   entity       optional — table the action touched
//   entity_id    optional — pk of the row (uuid)
//   ip           clientIp(req)
//   user_agent   first 500 chars
//   meta         JSONB — small structured payload (avoid PII)
...
// actor_id / entity_id to link to the source rows.
  ...
  try {
    await pool.query(
      `INSERT INTO audit_log
         (actor_id, action, entity, entity_id, ip, user_agent, meta)

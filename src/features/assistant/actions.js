...
const PLACES = [
  ...
  { section: "planner", reply: "Opening your **Calendar** — the one place lessons, quizzes and homework sit on days. Put something on a day and the dashboard follows.",
    words: ["scheduler", "planner", "timetable", "schedule", "calendar", "agenda"] },

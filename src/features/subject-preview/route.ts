...
/** Which of the two people this route belongs to. */
export const roleOf = (r: Route): "teacher" | "student" =>
  r.v === "student" || r.v === "studentSubject" ? "student" : "teacher";

/** The subject a route is inside, if any — the sidebar reads this. */
export const subjectOf = (r: Route): string | null =>
  r.v === "subject" || r.v === "kind" || r.v === "item" ? r.s : null;

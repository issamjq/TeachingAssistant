...
// Tri-state pill toggle: Light / System / Dark.
// Order matters: light → system → dark mirrors the visual brightness
// curve, so the active indicator only ever travels in one direction
// when you cycle through.
const OPTIONS = [

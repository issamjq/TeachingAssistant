...
// Field: label + input + persistent helper, inline-replaced by error
// when invalid. Always renders a label — never placeholder-as-label.
    ...
    <div className={["flex flex-col gap-1.5", className].join(" ")}>
      {label && (
        ...
        >
          {label}
          {required && (
            <span className="text-[var(--color-danger)] ms-0.5" aria-hidden>
              *
            </span>
          )}
        </label>

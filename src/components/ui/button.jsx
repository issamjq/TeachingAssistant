...
// Button — Murchid v2.0. Sizes sm/md/lg, variants
// primary/secondary/ghost/destructive. Loading state replaces text
// with a 3-dot pulse (no spinner per the design system). Focus ring
...
const variants = {
  ...
  // Legacy aliases — kept so existing callers from v1.1 don't break.
  outline:

...
import type { Plan, PlanId } from "../shared/types/domain";
...
export const PLAN_IDS: PlanId[] = [...PLANS.map((p) => p.id), TRIAL_PLAN_ID];
export const getPlan = (id: string): Plan | Pick<Plan, "id" | "durationDays"> | null => {

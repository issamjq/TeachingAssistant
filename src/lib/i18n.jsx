...
const EN = {
  ...
  "lp.ts.draftedBy": "Drafted by Mudir",
  // landing — workflow
  "lp.wf.eyebrow": "From real classrooms",
  "lp.wf.h2a": "Real teachers.",
  "lp.wf.h2b": "Real time back.",
  "lp.wf.sub": "Four teachers, four tasks that used to eat their evenings — now drafted by Mudir in the time it takes to read this.",
  // landing — final CTA
  "lp.cta.eyebrow": "Now in pilot — UAE schools",
  "lp.cta.h1a": "Get your",
  "lp.cta.h1b": "evenings back.",
  "lp.cta.sub": "Open the planner and let Mudir draft your next lesson, quiz, or deck — you stay in charge of every word.",
  // landing — footer
  ...
  "lp.foot.teamBody": "We're a small team building Mudir alongside teachers in Dubai and Abu Dhabi.",
  "lp.foot.openPlanner": "Open the planner →",
  "lp.foot.copyright": "© 2026 Mudir. Made in Dubai.",
  ...
  "lp.pg.signin.newQ": "New to Mudir?",
  ...
  "lp.pg.privacy.lead": "Mudir is built for schools that take student data seriously. Privacy is a default, not a setting.",
  ...
  "lp.pg.moe.lead": "Mudir speaks the curriculum your inspectors do — every output can be mapped to Ministry of Education outcomes.",
  ...
  "lp.pg.schools.title": "Bring Mudir to",
  ...
  "lp.pg.pricing.lead": "Mudir is in an invite-only pilot with UAE schools. Pricing for teachers and schools comes after the pilot — shaped by what teachers actually use.",
...
const AR = {
  ...
  "lp.ts.draftedBy": "من إعداد Mudir",
  // landing — workflow
  "lp.wf.eyebrow": "من صفوف حقيقية",
  "lp.wf.h2a": "معلّمون حقيقيّون.",
  "lp.wf.h2b": "ووقت حقيقي يعود إليك.",
  "lp.wf.sub": "أربعة معلّمين، أربع مهام كانت تلتهم أمسياتهم — يصوغها Mudir الآن في زمن قراءة هذا السطر.",
  // landing — final CTA
  "lp.cta.eyebrow": "في مرحلة تجريبية — مدارس الإمارات",
  "lp.cta.h1a": "استعِد",
  "lp.cta.h1b": "أمسياتك.",
  "lp.cta.sub": "افتح المُخطِّط ودع Mudir يصوغ درسك أو اختبارك أو عرضك القادم — وتبقى أنت المتحكِّم بكل كلمة.",
  // landing — footer
  ...
  "lp.foot.teamBody": "نحن فريق صغير نبني Mudir جنبًا إلى جنب مع معلّمين في دبي وأبوظبي.",
  "lp.foot.openPlanner": "افتح المُخطِّط ←",
  "lp.foot.copyright": "© 2026 Mudir. صُنع في دبي.",
  ...
  "lp.pg.signin.newQ": "جديد على Mudir؟",
  ...
  "lp.pg.privacy.lead": "بُني Mudir لمدارس تأخذ بيانات الطلبة على محمل الجد. الخصوصية إعداد افتراضي، لا خيار.",
  ...
  "lp.pg.moe.lead": "يتحدّث Mudir لغة المنهج التي يتحدّثها مفتّشوك — وكل مُخرَج يمكن ربطه بنواتج وزارة التربية.",
  ...
  "lp.pg.schools.title": "اجلب Mudir إلى",
  ...
  "lp.pg.pricing.lead": "Mudir في تجربة بدعوة فقط مع مدارس إماراتية. تسعير المعلّمين والمدارس يأتي بعد التجربة — يصوغه ما يستخدمه المعلّمون فعلًا.",

...
export function CardsGrid({ children }) {
  // Stagger each card's entrance ~40ms apart so the grid assembles
  // rather than appearing in a single flash. Pure CSS — cheap, and
  // automatically respects prefers-reduced-motion via the global

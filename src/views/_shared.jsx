...
// The api() implementation now lives in shared/lib/apiClient.ts (typed,
// with a real ApiError class carrying status + code). Re-exported here so
// the ~40 legacy views that `import { api } from "./_shared"` keep working
// untouched — there is one implementation, not two.
//
// New code should import from "@/shared/lib/apiClient" directly and use the
// generic parameters: api<Response, Body>(path, opts).
// Imported (not just re-exported) because useTeacherClasses below calls

...
//
// Fonts are still loaded via the Google Fonts <link>, carried over from
// index.html. The app pulls 25 families (the SlideBuilder theme picker
// offers them as deck typefaces), so next/font would mean 25 self-hosted
// loaders and a much slower build. Narrowing it to the families actually
// used at runtime is a Phase 5 performance item.
//
...
// interpolated, which is what the landing's scroll-linked weight animation
// needs (see .atl-word / --atl-wght in landing.css). Rendering at any fixed
// weight is unchanged; this is strictly a capability gain, and it ships
// fewer files.

const GOOGLE_FONTS_HREF =
  "https://fonts.googleapis.com/css2?family=Fraunces:ital,opsz,wght@0,9..144,300..900;1,9..144,300..900&family=Inter+Tight:wght@400;500;600;700&family=Amiri:wght@400;700&family=Playfair+Display:ital,wght@0,400;0,600;0,800;1,400&family=Lora:ital,wght@0,400;0,600;1,400&family=EB+Garamond:ital,wght@0,400;0,600;1,400&family=Cormorant+Garamond:ital,wght@0,400;0,600;1,400&family=Source+Serif+4:ital,wght@0,400;0,600;1,400&family=Crimson+Pro:ital,wght@0,400;0,600;1,400&family=Manrope:wght@400;600;700&family=Plus+Jakarta+Sans:ital,wght@0,400;0,600;0,700;1,400&family=Space+Grotesk:wght@400;500;700&family=DM+Sans:ital,wght@0,400;0,600;1,400&family=Outfit:wght@400;600;700&family=IBM+Plex+Mono:ital,wght@0,400;0,600;1,400&family=Space+Mono:ital,wght@0,400;0,700;1,400&family=Bebas+Neue&family=Shrikhand&family=Pacifico&family=Caveat:wght@400;600&family=Dancing+Script:wght@400;600&family=Cairo:wght@400;600;700&family=Reem+Kufi:wght@400;600&display=swap";
